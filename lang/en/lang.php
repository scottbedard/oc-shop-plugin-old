...
return [
    ...
    'drivers' => [
        ...
        'paypalexpress' => [
            ...
            'logo'                      => 'Logo',
            'logo_comment'              => 'Logo should be no larger than 190px wide or 60px tall.',
    ...
    'settings' => [
        ...
        'cart' => [
            ...
            'validation_comment'        => 'Validation will occur on any page that loads item details, such as the cart or checkout pages.',
            'validation_off'            => 'Off, allow users to purchase beyond the maximum available inventory',
    ...
    'statuses' => [
        ...
        'inventory_reduce'              => 'Reduce',
        'inventory_none'                => 'None',
        'inventory_restock'             => 'Restock',
        'inventory_comment'             => 'Inventories will never be reduced or restocked twice in a row.',
