...
return [
    ...
    'promotions' => [
        ...
        'required_products_comment'     => 'One or more required products must be purchased for the promotion to apply.',
        'shipping_amount'               => 'Shipping discount',
        'shipping_countries'            => 'Shipping restriction',
        'shipping_countries_comment'    => 'If enabled, customers must reside in one of the given countries to utilize a shipping promotion.',
